...
export class Model {
    ...
    constructor(private gl: WebGL2RenderingContext, private _droidModelURL: string, private _diffuseTextureURL?: string) {
        this._mesh.loadObj(this._droidModelURL, this.gl);
